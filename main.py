"""
LLM-Assisted Path Negotiation on Warehouse — POGEMA Simulation

Usage:
    python main.py [--map PATH] [--obs-radius N] [--max-steps N] [--no-render] [--seed N]
"""
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=DEFAULT_MAP,
        help='Path to map config JSON (default: maps/corridor.json)',
    )
    parser.add_argument(
        '--obs-radius',
        type=int,
