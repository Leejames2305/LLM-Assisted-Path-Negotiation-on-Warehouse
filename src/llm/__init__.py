...
class OpenRouterClient:
    ...
    def send_request(self, model: str, messages: List[Dict], max_tokens: int = 12800, temperature: float = 0.7, return_full_response: bool = False, **kwargs) -> Union[Optional[str], Tuple[Optional[str], Dict]]:
        if not self.api_key:
